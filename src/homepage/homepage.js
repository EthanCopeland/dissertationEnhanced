	...
	return (
		<div id="homepage">
			...
			<div id="content" className="pure-u-3-5">
				...
				<div id="hidden" className="pure-u-1-3"><img src={logo} alt="ellipse" /><p className="centered" id="target">Have a browse around and see if there is anything you like </p> </div>
				<div id="hidden" className="pure-u-1-3"><img src={logo1} alt="ellipse" /><p className="centered" id="target">We will send out your products as soon as we receive the purchase notification</p></div>
				<div id="hidden" className="pure-u-1-3"><img src={logo2} alt="ellipse" /><p className="centered" id="target">If you don't like the product you can receive a refund or exchange for another product</p></div>
			</div>
