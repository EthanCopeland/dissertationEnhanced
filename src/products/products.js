			...
			<section className="About">
				...
				<section className="product-background">
					<div className="pure-u-3-5">
						...
						<p className="products-p" id="target">Open 24/7 Just for you! <br /><br /> We hope you can find the gift sets most suitable for you here, with ranges from our starter bundle with the basic products such as a hat, pair of gloves, and a scarf to the mega bundle. Including two premium hats, gloves and scarves of higher quality for you and an extra.</p>
					</div>
				</section>
